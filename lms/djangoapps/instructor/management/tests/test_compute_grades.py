...
class InstructorCommandsTest(TestCase):
    ...
    def test_compute_grades_command(self):
        ...
        self.assertEqual(offline_grade_calculation.call_count, 1)  # pylint: disable=no-member
    ...
    def test_compute_grades_command_multiple_courses(self):
        ...
        self.assertEqual(offline_grade_calculation.call_count, 2)  # pylint: disable=no-member
